$(window).load(function(){
    ...
    var img3_discript = $('<div class="box_3"><p class="discript1">BOX dolor sit amet.</p></div>');
    var img4_discript = $('<div class="box_4"><p class="discript2">BOX2 dolor sit amet.</p></div>');
