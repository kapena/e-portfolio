$(window).load(function(){
    ...
    var imgs = $('.img1,.img2');
    // Content
    var img1_discript = $('<div class="box_1"><p class="discript1">Booklet Front & Back View</p></div>');
    var img2_discript = $('<div class="box_2"><p class="discript2">Booklet Front View</p></div>');
